...
//        });
    ...
    public void updateUI()
    {
        ...
        database.open();
        Cursor c = database.getNewTasks();

        if (c.getCount() > 0)
        {
            while (c.moveToNext()) {
                mContentItems.add(new TaskInfo(c.getString(1), c.getString(2), c.getString(3), c.getString(4), c.getString(5),
